public class Combinatorics {
    ...
    // How many combinations can we have with 4 flavors of ice cream if I can choose
    // unique 2 of them ?
    ...
    // 2 of them ?
    // (chocolate + vanilla = vanilla + chocolate)
    // But we can repeat the flavor (ex: chocolate + chocolate, vanilla + vanilla,
    // etc)
    ...
    // [The order matters]
    // How many ways can I choose my 2 favorite flavors of ice cream presented 4
    // flavors
    static int permutation(final int n, final int k) { // Arranjo
        return factorial(n) / factorial(n - k);
    }

    // In how many different orders we can put 4 scoops of ice cream if we have 2
    // flavors to choose
    // But I can repeat the flavor (ex: chocolate + chocolate, vanilla + vanilla,
    // etc)
    static int permutationWithRepetition(final int n, final int k) {
        return (int) Math.pow(n, k);
    }

    // In how many different orders, you can put 4 different flavors of ice cream in an ice
    // cream cone
